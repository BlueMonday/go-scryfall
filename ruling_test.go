...
func TestGetRulingsByMultiverseID(t *testing.T) {
	...
	mux.HandleFunc("/cards/multiverse/3255/rulings", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
...
func TestGetRulingsByMTGOID(t *testing.T) {
	mux := http.NewServeMux()
	mux.HandleFunc("/cards/mtgo/57934/rulings", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
...
func TestGetRulingsBySetCodeAndCollectorNumber(t *testing.T) {
	mux := http.NewServeMux()
	mux.HandleFunc("/cards/ima/65/rulings", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
...
func TestGetRulings(t *testing.T) {
	mux := http.NewServeMux()
	mux.HandleFunc("/cards/f2b9983e-20d4-4d12-9e2c-ec6d9a345787/rulings", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
